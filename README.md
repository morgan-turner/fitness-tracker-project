...
Analysis of average daily step count over a 24 hour period serves as a measure for what time of day users perfer to be active. The two most popular times of day for users too be active are in the middle of the day (perhaps on lunch break from work) and immediately after the workday, with the highest average user activity recorded during the 6:00pm hour. Users were rarely active during the early morning hours when people are usually asleep.

<img width="985" alt="activity per hour" src="https://user-images.githubusercontent.com/92185928/172989376-aa458add-e473-44c0-ad00-2bc3a475c2ea.png">
