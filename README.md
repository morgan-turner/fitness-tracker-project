...
Initial analysis of user activity shows that users are primarily sedentary when wearing fitness devices. This observation makes logical sense, since sleep takes up one third of a 24-hour period. Many users may have sedentary jobs to account for the other length of inactive time. 
